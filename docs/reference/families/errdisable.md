...
- Shape: `singleton`
- netascode portal: [https://netascode.cisco.com/docs/data_models/iosxe/device/errdisable/](https://netascode.cisco.com/docs/data_models/iosxe/device/errdisable/)

## YANG paths

- `/Cisco-IOS-XE-native:native/errdisable`
