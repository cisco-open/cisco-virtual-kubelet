...
- Shape: `singleton`
- netascode portal: [https://netascode.cisco.com/docs/data_models/iosxe/device/spanning_tree/](https://netascode.cisco.com/docs/data_models/iosxe/device/spanning_tree/)

## YANG paths

- `/Cisco-IOS-XE-native:native/spanning-tree`
