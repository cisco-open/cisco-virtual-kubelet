...
- Shape: `singleton`
- netascode portal: [https://netascode.cisco.com/docs/data_models/iosxe/device/ip_name_server/](https://netascode.cisco.com/docs/data_models/iosxe/device/ip_name_server/)

## YANG paths

- `/Cisco-IOS-XE-native:native/ip/name-server`
