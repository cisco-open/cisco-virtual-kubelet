...
This document covers everything an operator needs to invoke, schedule, and audit diagnostics through cisco-vk on a real device. All examples were validated against a live Cat9300 / IOS-XE 17.18.01 on 2026-04-28; the captured outputs live in the source-branch git history.
...
Full capture YAMLs and run logs live in the source-branch git history.
...
- Live retest evidence lives in the source-branch git history.
