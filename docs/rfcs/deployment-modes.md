...
**Tested against:** Cat9300-24P / IOS-XE 17.18.2 (cat9k-smoke device, 2026-04-27 evidence bundle; captured outputs live in the source-branch git history).
**Last validated:** branch `pr/johalley/nacxe`, image tag `phase9-crb-fix` (= v29 = commit `4b0ef79`).
...
Live-device evidence bundles are intentionally not copied here; they live in the source-branch git history.
...
This is the construct validated by the 2026-04-27 candidate-only evidence bundle; the captured outputs live in the source-branch git history. Tests 06 + 07 over this construct land at phase=InSync.
