# Architectural review — `pr/johalley/nacxe`
...
The mapping to netascode primitives is exhaustive; the primitive-by-primitive
matrix remains in the source-branch git history. Three CVK extensions are additive and do not break
netascode parity:
