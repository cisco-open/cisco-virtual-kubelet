...
**Sample outputs:** lifted verbatim from the [2026-04-27 live-device evidence bundle](./final/evidence/2026-04-27-live-c9300-netconf-candidate-only/SUMMARY.md).
...
- [`./final/evidence/`](./final/evidence/) — captured outputs from live-device validation
