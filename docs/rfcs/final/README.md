...
| **Release-readiness evaluation** — pre-tag punch-list, dimensional verdicts, cited gaps, post-readiness fixes table | [`./release-readiness-evaluation.md`](./release-readiness-evaluation.md) |
| **Production deployment guide** — operator-facing reference with mermaid architecture/flow diagrams, day-1/day-2 playbook, hardening checklist, roadmap-by-deployment-tier | [`./production-deployment-guide.md`](./production-deployment-guide.md) |
| **Roadmap** — six-tier forward plan covering closed pre-tag fixes, planned Wave 11, multi-Wave architectural items, test infrastructure, external infrastructure, and doc-only closures; with mermaid Gantt-style calendar | [`./roadmap.md`](./roadmap.md) |
