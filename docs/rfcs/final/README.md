...
| **Release-readiness evaluation** — pre-tag punch-list, dimensional verdicts, cited gaps | [`./release-readiness-evaluation.md`](./release-readiness-evaluation.md) |
| **Production deployment guide** — operator-facing reference with mermaid architecture/flow diagrams, day-1/day-2 playbook, hardening checklist | [`./production-deployment-guide.md`](./production-deployment-guide.md) |
