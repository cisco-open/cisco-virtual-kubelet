// SKIPPED: extract schema: yang_path "/Cisco-IOS-XE-native:native/ip/as-path/access-list": not found in native schema
package cfgval_ip_as_path_access_list_1716
