// SKIPPED: extract schema: yang_path "/Cisco-IOS-XE-native:native/ip/access-list/standard": not found in native schema
package cfgval_access_list_standard_2601
