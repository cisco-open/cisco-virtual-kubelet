// SKIPPED: extract schema: yang_path "/Cisco-IOS-XE-native:native/ip/access-list/extended": not found in native schema
package cfgval_access_list_extended_1718
