...
// Package configdriver reconciles IOS-XE device configuration against the
// IOSXEConfig family of CRs (config.cisco.vk/v1alpha1).
//
// The driver is loaded inside the per-device cisco-vk run process alongside
// the existing IOx application driver; it shares the RESTCONF/NETCONF
