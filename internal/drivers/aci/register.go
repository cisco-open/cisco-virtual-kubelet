...
func init() {
	drivers.Register(v1alpha1.DeviceDriverACI,
	...
	// claim ACI devices. ACI uses provider.APICConfigReconciler rather than the
	// IOS-XE YANG ConfigReconciler, so the context is intentionally empty.
	drivers.RegisterConfigDriver(v1alpha1.DeviceDriverACI,
