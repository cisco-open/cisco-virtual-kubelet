...
// Package junos is the Junos platform driver placeholder. It exists
// so the Phase-9 plug-in pattern is observable end-to-end: the
// directory layout, the register.go shape, and the Driver enum
// constant (DeviceDriverJUNOS) are all in place, ready for the real
...
//  3. Add `_ "…/internal/drivers/junos"` to
