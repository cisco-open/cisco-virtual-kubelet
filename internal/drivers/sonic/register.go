...
func init() {
	drivers.Register(v1alpha1.DeviceDriverSONIC,
	...
	// claim SONiC devices. SONiC uses provider.SONICConfigReconciler rather than
	// the IOS-XE YANG ConfigReconciler, so the context is intentionally empty.
	drivers.RegisterConfigDriver(v1alpha1.DeviceDriverSONIC,
