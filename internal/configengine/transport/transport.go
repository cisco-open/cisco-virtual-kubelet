...
// Package transport provides the platform-neutral device configuration
// transport contract used by IOS-XE, NX-OS, and future device-centric
// drivers.
//
...
type Capabilities struct {
	...
	// read-only operational commands and return their textual output.
	//
...
// DiagnosticExecer runs read-only operational commands and returns
// their textual output. IOS-XE backs this with Cisco-IA RPCs; NX-OS
// backs it with NX-API show commands.
//
...
// Optional — transport capabilities report SupportsDiagnosticExec so callers
// can branch without type-asserting.
